...
describe('GoogleBooksService', () => {
  ...
  it('should return books when searched', fakeAsync(() => {
        ...
        'items': [
          {
            ...
            'volumeInfo': {
              ...
              'description': 'Fundamentals of Biomechanics introduces the exciting world of how human movement is '
                        + 'created and how it can be improved. Teachers, coaches and physical therapists all use biomechanics to '
                        + 'help people improve movement and decrease the risk of injury. The book presents a comprehensive review '
                        + 'of the major concepts of biomechanics and summarizes them in nine principles of biomechanics. Fundamentals '
                        + 'of Biomechanics concludes by showing how these principles can be used by movement professionals to improve '
                        + 'human movement. Specific case studies are presented in physical education, coaching, strength and conditioning, '
                        + 'and sports medicine.',
              'industryIdentifiers': [
                {
                  'type': 'ISBN_10',
              ...
              'imageLinks': {
                'smallThumbnail': 'http://books.google.com/books/content'
                                + '?id=js2P_8lbR2wC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api',
                'thumbnail': 'http://books.google.com/books/content?id=js2P_8lbR2wC'
            ...
            'accessInfo': {
              ...
              'pdf': {
                'isAvailable': true,
                'acsTokenLink': 'http://books.google.co.uk/books/download/Fundamentals_of_Biomechanics-sample-pdf.acsm'
                             + '?id=js2P_8lbR2wC&format=pdf&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api'
              },
              'webReaderLink': 'http://books.google.co.uk/books/reader?id=js2P_8lbR2wC&hl=&printsec=frontcover'
                            + '&output=reader&source=gbs_api',
              'accessViewStatus': 'SAMPLE',
              'quoteSharingAllowed': false
            },
            'searchInfo': {
              'textSnippet': 'The \u003cb\u003eangular\u003c/b\u003e velocities of joints are particularly relevant in '
                        + 'biomechanics, \u003cbr\u003e\nbecause they represent the \u003cb\u003eangular\u003c/b\u003e speed of anatomical '
                        + 'motions. If relative \u003cbr\u003e\nangles are calculated between anatomical segments, the \u003cb\u003eangular'
                        + '\u003c/b\u003e velocities \u003cbr\u003e\ncalculated can&nbsp;...'
            }
          },
          {
            ...
            'volumeInfo': {
              ...
              'publishedDate': '2005',
              'description': '"Biomechanics of Sport and Exercise, Second Edition," introduces exercise and sport biomechanics in concise '
                          + 'terms rather than focusing on complex math and physics. This book helps students learn to appreciate external '
                          + 'forces and their effects, how the body generates forces to maintain position, and how forces create movement '
              ...
              'contentVersion': 'preview-1.0.0',
              'imageLinks': {
                'smallThumbnail': 'http://books.google.com/books/content?id=PrOKEcZXJ58C&printsec=frontcover'
                                      + '&img=1&zoom=5&edge=curl&source=gbs_api',
                'thumbnail': 'http://books.google.com/books/content?id=PrOKEcZXJ58C&printsec=frontcover'
            ...
            'accessInfo': {
              ...
              'webReaderLink': 'http://books.google.co.uk/books/reader?id=PrOKEcZXJ58C&hl='
      ...
      const req = httpMock.expectOne('Angular');
      req.flush(response);
  ...
  it('should return a single book when requested', fakeAsync(() => {
      ...
      const req = httpMock.expectOne('js2P_8lbR2wC');
      req.flush(response);
